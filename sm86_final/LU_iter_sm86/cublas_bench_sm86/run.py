...
def compile_cuda(matrix_size: int, num_matrices: int) -> None:
...
def run_ncu_profile(matrix_size: int, num_matrices: int, ncu_dir: str) -> None:
    ...
    try:
        for num_matrices, matrix_name in zip(num_matrices_list, matrix_names):
            ...
            for matrix_size in matrix_sizes:
                ...
                compile_cuda(matrix_size, num_matrices)
                    
                # Run NCU profiling
                # Run NCU profiling
                # run_ncu_profile(matrix_size, num_matrices, ncu_matrix_dir)
