...
# Read the JSON file
with open("benchmark_results_500k.json", 'r') as f:
    data = json.load(f)
...
with open("nohup_no_swzl_subwarp.out", 'r') as reg_f:
    for line in reg_f:
...
fig.suptitle('No swizzle Performance Analysis Metrics for 500k Matrices', fontsize=16, fontweight='bold')
...
# Save the plot
plt.savefig('no_swzl_500k_performance_analysis.png', dpi=500, bbox_inches='tight')
# save the plot as .svg in high dpi to be used in latex document
plt.savefig('no_swzl_500k_performance_analysis.svg', dpi=500, bbox_inches='tight')
