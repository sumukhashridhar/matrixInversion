...
with open("nohup_parallel_pivot.out", 'r') as reg_f:
    for line in reg_f:
...
fig.suptitle('Parallel Pivot Performance Analysis Metrics', fontsize=16, y=0.95)
...
# Save the plot
plt.savefig('par_piv_performance_analysis.png', dpi=300, bbox_inches='tight')
