...
with open("nohup_shfl.out", 'r') as reg_f:
    for line in reg_f:
...
fig.suptitle('Shuffle Performance Analysis Metrics', fontsize=16, y=0.95)
...
# Save the plot
plt.savefig('shfl_performance_analysis.png', dpi=300, bbox_inches='tight')
