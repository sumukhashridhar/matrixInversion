...
with open("nohup_serial_pivot.out", 'r') as reg_f:
    for line in reg_f:
...
fig.suptitle('Serial Pivot Performance Analysis Metrics', fontsize=16, y=0.95)
...
# Save the plot
plt.savefig('ser_piv_performance_analysis.png', dpi=300, bbox_inches='tight')
